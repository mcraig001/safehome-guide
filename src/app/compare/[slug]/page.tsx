...
const COMPARISON_META: Record<string, {
  ...
  'best-walk-in-tubs': {
    ...
    faqs: [
      ...
      { question: 'What door threshold height should I look for?', answer: 'Door threshold height is the single most important safety specification on a walk-in tub. Look for under 3 inches — the lower the better. Some premium models have 2-inch thresholds. A higher threshold increases fall risk at entry/exit. Always confirm this spec before purchase, as it varies even within a brand\'s model lineup.' },
      { question: 'Which walk-in tub features are worth paying extra for?', answer: 'Worth the upgrade: fast-drain technology (under 90 seconds vs. 3–5 minutes — you must stay inside while it drains), chromotherapy lighting (has therapeutic value for mood), and a handheld shower wand. Not worth the premium for most buyers: aromatherapy, heated surfaces (maintenance-heavy), and extended hydrotherapy packages if joint pain is not a primary concern.' },
    ],
  },
  'best-grab-bars': {
  ...
  'best-medical-alerts': {
    ...
    faqs: [
      ...
      { question: 'What is the response time for a medical alert system?', answer: 'Top medical alert systems connect to a monitoring center within 15–30 seconds of activation. This is measured as time from button press to operator response. Bay Alarm Medical and Medical Guardian consistently post under 30-second response times in third-party tests. Life Alert averages 45–60 seconds in published data. Response time is a key differentiator — a faster response matters in cardiac emergencies.' },
      { question: 'Can a family member be notified instead of calling 911?', answer: 'Yes — most medical alert systems allow you to customize the response protocol. You can set up a call tree where family members are contacted first (before 911), or add family members to be notified simultaneously when an alert is triggered. This feature is especially useful for seniors who live near family or who want loved ones informed before emergency services arrive.' },
    ],
  },
  ...
  'best-bath-safety-products': {
    ...
    faqs: [
      ...
      { question: 'What is a transfer bench and who needs one?', answer: 'A transfer bench has one side outside and one side inside the tub — you sit on the outside portion and slide inward, eliminating the need to step over the tub wall. It\'s essential for seniors who cannot safely step over a tub edge due to balance problems, hip replacement, or severe arthritis. It\'s the lowest-cost solution ($60–$150) for making a standard tub accessible without removing it.' },
      { question: 'Is a handheld showerhead necessary with a shower chair?', answer: 'Highly recommended. Without a handheld showerhead, seated showering requires turning, reaching, and repositioning around a fixed overhead shower — which creates fall risk. A handheld showerhead on a slide bar ($30–$100) combined with a shower chair is the minimum effective safety setup for seated bathing. This combination covers 80% of seniors\' bathing safety needs at minimal cost.' },
    ],
  },
  ...
  'best-smart-door-locks': {
    ...
    faqs: [
      ...
      { question: 'Do smart locks need Wi-Fi to work?', answer: 'Many smart locks work without Wi-Fi for basic keypad and key use — they only need Wi-Fi or Bluetooth for remote access and app features. Schlage Encode uses Wi-Fi; Schlage Connect uses Z-Wave (requires a compatible hub). If the internet goes out, most smart locks still function locally via keypad. Always confirm a lock has a physical key backup for power outages or system failures.' },
      { question: 'How do I give a caregiver access to a smart lock without giving them a physical key?', answer: 'Smart locks allow temporary or permanent PIN codes for individual users. You can add a caregiver PIN, set it to work only during care hours (e.g., weekdays 8am–6pm), and delete it instantly if needed. Some locks (like August and Schlage) let you share access via a smartphone app. This is the most secure way to give caregivers access — no physical key that can be copied or lost.' },
    ],
  },
};
