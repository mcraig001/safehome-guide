...
const guides = [
  ...
  },
  {
    ...
    description: 'Room-by-room home safety checklist: bathroom, bedroom, kitchen, stairs, and entryways. What to check and which modifications to prioritize first.',
    category: 'Planning',
    icon: '📋',
    readTime: '6 min read',
    type: 'planning',
  ...
  {
    slug: 'how-to-choose-home-health-aide',
    title: 'How to Choose a Home Health Aide: Complete Guide (2026)',
    description: 'What home health aides do, how much they cost, agency vs. independent comparison, what Medicare covers, and how to find a qualified aide near you.',
    category: 'Planning',
    icon: '🏥',
    readTime: '6 min read',
    type: 'planning',
  ...
  {
    slug: 'living-alone-senior-safety',
    title: 'Safety Guide for Seniors Living Alone: Risks, Solutions & Peace of Mind (2026)',
    description: 'Safety for seniors living alone: medical alerts, check-in routines, smart monitoring without cameras, social connection programs, and warning signs.',
    category: 'Medical Alerts',
    icon: '🏡',
    readTime: '6 min read',
    type: 'planning',
  },
  {
    ...
    description: 'The 7 universal design principles, most important UD features for aging in place, visitability standards, and how UD affects home resale value.',
    category: 'Planning',
    icon: '📐',
    readTime: '7 min read',
    type: 'planning',
  ...
  {
    slug: 'knee-replacement-home-modifications',
    title: 'Home Modifications After Knee Replacement: What to Set Up Before Surgery (2026)',
    description: 'Pre-surgery home setup for knee replacement: raised toilet seat, ice machine, furniture arrangement, stair protocol, and week-by-week recovery timeline.',
    category: 'Bath Safety',
    icon: '🦵',
    readTime: '6 min read',
    type: 'planning',
  ...
  {
    slug: 'senior-garage-modifications',
    title: 'Garage Safety & Accessibility Modifications for Seniors (2026)',
    description: 'Garage safety for seniors: entry step grab bars, smart garage door openers, fall hazard removal, lighting, and garage conversion for accessible living.',
